...
<div class="pd-20">
	<div class="mt-20">
	<form action="#" method="post" id="form-assign-student">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach var="student" items="${studentList}">
			<tr class="text-c">
				<td><input type="checkbox" value="<c:out value="${student.workId}"></c:out>" name="sid"></td>
...
$(function(){
	$("#submit").click(function(){
		...
		$.ajax({ 
			type: "POST", 
			url: "choise/distribute?teacherId=${teacherId}&studentId=" + checkedList, 
			success: function(msg) { 
				layer.msg('学生分配成功',{icon: 6,time:1000});
				clock();
			} ,
			error : function(e) {
				layer.msg('学生分配失败',{icon: 5,time:1000});
			}
		}); 
	});
});
